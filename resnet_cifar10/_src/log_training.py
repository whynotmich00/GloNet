...
def plot_training_metrics(metrics: Dict, folder_name: str):
    ...
    metric_axes = [plt.subplot(gs[0, 0]), plt.subplot(gs[0, 1]), plt.subplot(gs[1, 0]), plt.subplot(gs[1, 1])]
    param_norm_axes = plt.subplot(gs[2, :])
    interm_outputs_norm_axes = plt.subplot(gs[3, :])
