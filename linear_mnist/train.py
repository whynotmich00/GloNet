...
flags.DEFINE_integer("features", 256, "Output dimension for each hidden layer in the network")
flags.DEFINE_integer("num_layers", 10, "Number of layers of the network")
