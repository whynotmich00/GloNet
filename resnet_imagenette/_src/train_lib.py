...
def train_model(flags):
    ...
    for epoch in tqdm(range(flags.epochs)):
        ...
        for step, (images, labels) in enumerate(train_ds):
            ...
            state, (loss, accuracy) = train_step(state, images, labels, criterion)
        ...
        for step, (images, labels) in enumerate(test_ds):
            ...
            if epoch == flags.epochs - 1:
                loss, acc, intermeditates_outputs = eval_step_with_intermediates(state, images, labels, criterion)
                ev_loss.append(loss)
                ev_acc.append(acc)
                ...
                loss, acc = eval_step(state, images, labels, criterion)
                ev_loss.append(loss)
                ev_acc.append(acc)
